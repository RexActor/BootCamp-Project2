...
const fetchSuggestions = async (query) => {
  ...
  return (
    <section className="text-center px-8 mt-6 sm:px-6">
      <div className="flex flex-col sm:flex-row justify-center items-center gap-2">
        <div className="relative rounded-full bg-white bg-opacity-50 shadow-lg flex sm:flex-grow-0"> {/* Added relative positioning here */}
