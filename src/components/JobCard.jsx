...
const JobCard = () => {
    ...
    return (
        <>
            <div>
                <h2 className=" bg-slate-100 text-left text-lg text-slate-900 min-w-min">{jobData.length} jobs </h2></div>
            <InfiniteScroll dataLength={jobAds.length} next={fetchData}
                hasMore={true}
                loader={<h4>Load More</h4>}
                endMessage={
                    <p className=" text-center text-slate-500">
                        <b>This is the latest jobs available for your search at this time.</b>
                    </p>
                }>
                        ...
                        <div className="col col-span-6 justify-center max-w-sm rounded overflow-hidden shadow-lg gap-10 m-2">
                            <div className="flex  justify-center py-11  ">
                                <div className="card  px-4 rounded-3xl w-[25rem] m-2">
                                    ...
                                    <div>
                                        <p className="  rounded-xl bg-gray-200 text-xs font-medium text-slate-950 w-32 py-1 px-1">£{job.salary_min}-£{job.salary_max}</p>
                                    </div>
                                    <div className="col col-span-5">
                                        ...
                                        <div>
                                            <h4 className="text-xs text-gray-500">{calcDuration(job.created)} days ago</h4>
                                        </div>
                                        <div><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
