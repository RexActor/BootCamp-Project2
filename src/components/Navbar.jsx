    ...
    <nav className="px-8 py-8 text-gray-800, bg-gray-100 ">
        <div className="mx-auto max-w-screen-lg flex justify-between items-center">
            <div className="flex items-center text-gray-800">
                <p className="text-xl font-medium gap-2.5 flex items-center">
                    {/* it is the logo */}
            ...
            <div className="flex items-center gap-4">
                ...
                <a href="#" className="block shrink-0">
                    ...
                    <img alt="Man" src="https://images.unsplash.com/photo-1600486913747-55e5470d6f40?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80" className="h-9 w-9 rounded-full object-cover" />
                </a>
            </div>
        </div>
    </nav>
