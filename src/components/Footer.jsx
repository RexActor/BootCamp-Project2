                ...
                <div className="mt-8 grid pt-8 gap-8 sm:grid-cols-3 lg:grid-cols-4">
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-6 space-y-4 text-sm">
                            <li>
                                <a className="transition hover:opacity-70" href="/"> About </a>
                            </li>
                            <li>
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-6 space-y-4 text-sm">
                            <li>
                                <a className="transition hover:opacity-70" href="https://github.com/RexActor/BootCamp-Project2"> Online
                                    Guides </a>
                            </li>
                            <li>
                                <a className="transition hover:opacity-70" href="https://github.com/RexActor/BootCamp-Project2"> Support
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="flex justify-center sm:justify-start lg:justify-end">
                        <p className="text-lg font-medium gap-2.5 flex sm:items-center">
      ...
      <div className="mx-auto max-w-screen-lg pt-2">
        <div className="mt-8 grid pt-8 gap-8 sm:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li>
                <a
                  className="transition hover:opacity-70"
                  href="https://github.com/Vickysug/project-1"
                >
                  {" "}
                  Online Guides{" "}
                </a>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li>
                <a className="justify-center gap-2.5">
                  Email:
