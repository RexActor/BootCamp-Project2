        ...
        <div className="mx-auto max-w-screen-lg  justify-between items-center">
          <div className="details basis-1/2">
            ...
            <div className="job-header border-b py-7 pl-3">
              ...
              <div className="mb-3">
                <span>${props.info.salary_min} a year</span>
                <span className="pl-7">full-time</span>
              </div>
              <a
                href={props.info.redirect_url}
                className="p-3 mt-3 inline-block bg-gray-500 rounded "
              >
                apply now
              </a>
            </div>
            <div className="job-sub-header  flex border-y py-7 pl-3">
              <div>
                ...
                <p className="ml-8 mb-3">
                  £ {props.info.salary_min} - £ {props.info.salary_max}
                </p>
                <div className="flex">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
